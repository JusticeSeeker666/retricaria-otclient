...
function onLevelChange(localPlayer, value, percent)
  ...
  local text = tr('You have %d percent to go', 100 - percent) .. '\n' ..
               tr('%d of experience left', expToAdvance(localPlayer:getLevel(), localPlayer:getExperience()))
  ...
  if localPlayer.expSpeed ~= nil then
     ...
     if expPerHour > 0 then
        ...
        text = text .. '\n' .. tr('%d experience per hour.', expPerHour)
...
function onStaminaChange(localPlayer, stamina)
  ...
  if stamina > 2400 and g_game.getClientVersion() >= 1038 and localPlayer:isPremium() then
  	local text = tr("You have %d hours and %d minutes left.", hours, minutes) .. '\n' ..
	...
	elseif stamina > 2400 and g_game.getClientVersion() >= 1038 and not localPlayer:isPremium() then
		local text = tr("You have %d hours and %d minutes left.", hours, minutes) .. '\n' ..
		tr("You will not gain 50%% more experience as a free account player.")
		setSkillPercent('stamina', percent, text, '#89F013')
	elseif stamina > 2400 and g_game.getClientVersion() < 1038 then
		local text = tr("You have %d hours and %d minutes left.", hours, minutes) .. '\n' ..
		tr("Premium accounts gain 50%% more experience.")
		setSkillPercent('stamina', percent, text, 'green')
	elseif stamina <= 2400 and stamina > 840 then
		setSkillPercent('stamina', percent, tr("You have %d hours and %d minutes left.", hours, minutes), 'orange')
	elseif stamina <= 840 and stamina > 0 then
		local text = tr("You have %d hours and %d minutes left.", hours, minutes) .. "\n" ..
		tr("Your stamina is low. You're gaining less exp and no loot.")
...
function onMagicLevelChange(localPlayer, magiclevel, percent)
  ...
  setSkillPercent('magiclevel', percent, tr('You have %d percent to go', 100 - percent))
...
function onSkillChange(localPlayer, id, level, percent)
  ...
  setSkillPercent('skillId' .. id, percent, tr('You have %d percent to go', 100 - percent))
